  const sunSigns = [
        ...
        function isDateInRange(date, startDate, endDate) {
            ...
            // Adjust year if endDate is before startDate in the calendar
            if (end < start) {
                end.setFullYear(year + 1); // Adjust the end year if date range spans the year end
            }

            // Handle year boundary for Sagittarius and Capricorn (December to January)
            if (startDate === "12-16" && endDate === "01-13") {
